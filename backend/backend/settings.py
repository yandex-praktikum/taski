...
sentry_sdk.init(
    dsn="https://3587f37c4e724305a53e44188560425e@o4505453253820416.ingest.sentry.io/4505453271842816",
    integrations=[
        DjangoIntegration(),
    ],
...
ALLOWED_HOSTS = ['taskiyandex.ddns.net','51.250.22.235', '127.0.0.1', 'localhost']
